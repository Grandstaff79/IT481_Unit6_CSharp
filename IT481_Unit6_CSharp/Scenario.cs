...
namespace IT481_Unit6_CSharp
{
    class Scenario
    {
        ...
        {
            //ClothingItems = 0 will indicate the use of a reandom number.
            //ClothingItems = 1 -20 will allow for the load testing by forcing a specific number of items.
            Console.Write("What ClothingItems value do you want? (0 = random)");
            controlItemNumber = Int32.Parse(Console.ReadLine());

            //Set the number of cutomers
            Console.Write("How many customers do you want? ");
            int numberOfCustomers = Int32.Parse(Console.ReadLine());
            Console.WriteLine("There are" + numberOfCustomers + "total of customers");
            ...
            //Create the dressing rooms object with the number of rooms
